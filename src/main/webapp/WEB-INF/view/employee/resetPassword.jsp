...
<div class="col-md-9">
    <h1>Reset password for ${sessionScope.employee.firstName} ${sessionScope.employee.lastName}</h1>
    <form:form action="${pageContext.request.contextPath}/employee/account/resetPassword" method="post" role="form" id="reset_password" name="reset_password">
...
<script>
    $(document).ready(function () {
        $('#reset_password').bootstrapValidator({
            message: 'This value in not valid',
            feedbackIcons: {
